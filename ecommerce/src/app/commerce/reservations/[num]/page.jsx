...
export default function Reservations({ params }) {
    ...
    return (
        <main id="user-login" style={{ backgroundImage: `url(${destination.image_url})`,
        }} className="container mx-auto px-4 h-screen flex-center bg-fixed bg-center bg-cover w-screen">
            <form method="post" action="/api/destinations/reservations/new" className="w-full max-w-lg" onSubmit={asyncSubmit}>
                ...
                <div className="bg-slate-700 bg-opacity-30 p-6 rounded-2xl">
